function About() {
  ...
  return (
    <section id="about" className="px-12 py-36 border-t border-[#1e1e1e] grid grid-cols-2 gap-24">
      ...
      <div>
        ...
        <h2 className="font-black leading-tight tracking-tight mb-7 text-5xl" style={{fontFamily: 'Syne, sans-serif'}}>
      ...
      <div className="pt-2">
        ...
        <div className="flex flex-col">
          {[
            ...
            <div key={name} className="flex justify-between items-center py-4 border-b border-[#1e1e1e]">
              <span className="text-sm text-white">{name}</span>
              <span className="text-xs text-[#6b6760] tabular-nums">{year}</span>
            </div>
          ))}
        </div>
      </div>
